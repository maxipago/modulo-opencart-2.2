        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <div class="pull-right">
                    ...
                    <button type="submit" form="form-maxipago" data-toggle="tooltip"
        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-maxipago" class="form-horizontal">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <select name="maxipago_cc_fraud_processor" id="select-cc-fraud-processor" class="form-control">
                                        <option value="99" <?php echo ($maxipago_cc_fraud_processor) ? 'selected="selected"' : null;?>>
                                        <?php echo $text_kount; ?>
                                        </option>
                                        <option value="98" <?php echo (!$maxipago_cc_fraud_processor) ? 'selected="selected"' : null;?>>
